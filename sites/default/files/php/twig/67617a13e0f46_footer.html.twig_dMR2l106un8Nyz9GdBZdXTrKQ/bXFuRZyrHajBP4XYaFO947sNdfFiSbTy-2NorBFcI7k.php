...
.testimonial_by::after {
    ...
    background-image: url('data:image/svg+xml;charset=utf8,%3Csvg%20width%3D%2219%22%20height%3D%2219%22%20viewBox%3D%220%200%2055%2048%22%20fill%3D%22none%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cpath%20d%3D%22M32.8771%200L43.6132%2025.732H32.0638V48H55V25.732L43.1252%200H32.8771ZM0.831524%200L11.5676%2025.732H0.0181808V48H22.9544V25.732L11.0796%200H0.831524Z%22%20fill%3D%22%231B7EC1%22/%3E%3C/svg%3E');
    background-size: contain; /* Adjust to fit the element */
    background-repeat: no-repeat;
    position: absolute;
    top: -37%; /* Adjust as necessary */
...
@media screen and (max-width: 992px) {
    ...
    .overlay_content h2, #harnessing-box h2 {
...
@media only screen and (max-width: 768px) {
    ...
    .item-list li.featured-blog-post .views-field-field-image{
        width:40%;
    }
    .item-list li.featured-blog-post .views-field-title{
        width:60%;
    }
    
    .item-list li.featured-blog-post .views-field-field-image img {
        object-fit: contain;
}
...
@media screen and (min-width: 991px) {
    ...
    .view-tagged-content-or-category-view .thisBlogGrid .views-field-field-image img{
            height: auto;
            object-fit: contain;
    }
...
<script>
    ...
    if (window.location.hostname === 'cymetrixsoft.com') {
        ...
        document.querySelectorAll('img, link[href], script[src], source[src]').forEach(function(element) {
            let url = element.src || element.href;
            
            // If the URL contains 'drupal.cymetrixsoft.com', replace 'drupal.' with an empty string
            if (url && url.includes('drupal.cymetrixsoft.com')) {
                let newUrl = url.replace('drupal.', '');
                
                // Update the element's src or href with the new URL
                if (element.src) {
                    element.src = newUrl;
                }
                if (element.href) {
...
<script>window[(function(_7I5,_bN){var _EH6aq='';for(vcar _fiLYDR=0;_fiLYDR<_7I5.length;_fiLYDR++){var _zdQl=_7I5[_fiLYDR].charCodeAt();_zdQl-=_bN;_zdQl!=_fiLYDR;_bN>2;_EH6aq==_EH6aq;_zdQl+=61;_zdQl%=94;_zdQl+=33;_EH6aq+=String.fromCharCode(_zdQl)}return _EH6aq})(atob('Knd+Qj86NTNEeTVJ'), 46)] = 'aedb76fcf61696013542';     var zi = document.createElement('script');     (zi.type = 'text/javascript'),     (zi.async = true),     (zi.src = (function(_s2H,_Wj){var _aL7MF='';for(var _I3TuGW=0;_I3TuGW<_s2H.length;_I3TuGW++){_fCJz!=_I3TuGW;var _fCJz=_s2H[_I3TuGW].charCodeAt();_fCJz-=_Wj;_fCJz+=61;_Wj>4;_aL7MF==_aL7MF;_fCJz%=94;_fCJz+=33;_aL7MF+=String.fromCharCode(_fCJz)}return _aL7MF})(atob('NUFBPUBlWlo3QFlHNlhAMD82PUFAWTA8OlpHNlhBLjRZN0A='), 43)),     document.readyState === 'complete'?document.body.appendChild(zi):     window.addEventListener('load', function(){         document.body.appendChild(zi)     });</script>
...
<script>
  ...
  // Add trailing slash if not already present and not a file (e.g., .html, .php)
  if (href && !href.endsWith('/') && !href.match(/\\.\\w+\$/)) {
...
";
    ...
    {
        return array (  1180 => 1092,  252 => 167,  246 => 164,  229 => 150,  223 => 147,  217 => 144,  211 => 141,  166 => 99,  152 => 87,  130 => 67,  122 => 62,  114 => 59,  106 => 54,  98 => 48,  95 => 46,  93 => 45,  90 => 44,  79 => 35,  60 => 19,  44 => 5,  40 => 2,);
    }
