...
/* __string_template__85c9c0924c1677f7446799e97e3da5f3 */
class __TwigTemplate_669e5911ead91ad530fe45230bfe755c extends Template
{
    private $source;
    private $macros = [];
...
<body style=\"font-family: Arial, sans-serif; color: #333; padding: 20px; background-color: #f9f9f9;\">
    <div style=\"max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 5px; padding: 20px; background-color: #ffffff;\">
        ...
        // line 20
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:full_name:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 20, $this->source)), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                ...
                <td style=\"border: 1px solid #ddd; padding: 8px;\">";
        // line 24
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:email:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 24, $this->source)), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                ...
                <td style=\"border: 1px solid #ddd; padding: 8px;\">";
        // line 28
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:phone_number:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 28, $this->source)), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                ...
                <td style=\"border: 1px solid #ddd; padding: 8px;\">";
        // line 32
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:current_year_of_work_experience:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 32, $this->source)), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                ...
                <td style=\"border: 1px solid #ddd; padding: 8px;\">";
        // line 36
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:current_annual_salary:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 36, $this->source)), "html", null, true);
        yield "</td>
            </tr>
        </table>
...
";
    ...
    {
        return "__string_template__85c9c0924c1677f7446799e97e3da5f3";
    }
    ...
    {
        return new Source("", "__string_template__85c9c0924c1677f7446799e97e3da5f3", "");
    }
