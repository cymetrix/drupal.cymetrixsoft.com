...
/* __string_template__a904c52c88ed13f0cdb7a30d0aedb1b6 */
class __TwigTemplate_67a6b42e83f5399dcecd4251e853f886 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div style=\"max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 5px; padding: 20px; background-color: #ffffff;\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td style=\"border: 1px solid #ddd; padding: 8px;\">";
        // line 33
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:current_annual_salary:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 33, $this->source)), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <td style=\"border: 1px solid #ddd; padding: 8px;\">Upload Resume</td>
                <td style=\"border: 1px solid #ddd; padding: 8px;\">
                    <a href=\"[webform_submission:values:attachment:webform_token_options_html:webform_token_options_email]\" style=\"color: #4CAF50; text-decoration: none;\">Download Resume</a>
                </td>
            </tr>
            <tr>
                ...
                <td style=\"border: 1px solid #ddd; padding: 8px;\">";
        // line 43
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\webform\Twig\WebformTwigExtension']->webformToken("[webform_submission:values:cover_letter:webform_token_options_html:webform_token_options_email]", $this->sandbox->ensureToStringAllowed(($context["webform_submission"] ?? null), 43, $this->source)), "html", null, true);
        yield "</td>
            </tr>
...
";
    ...
    {
        return "__string_template__a904c52c88ed13f0cdb7a30d0aedb1b6";
    }
    ...
    {
        return new Source("", "__string_template__a904c52c88ed13f0cdb7a30d0aedb1b6", "");
    }
