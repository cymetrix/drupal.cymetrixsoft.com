...
class __TwigTemplate_91ab61333865f7e6c13e70d61a19e9c8 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . Twig\Extension\CoreExtension::replace($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/content-edit/filter-tips.html.twig", "/home3/cymetrix/drupal.cymetrixsoft.com/themes/contrib/bootstrap5/templates/content-edit/filter-tips.html.twig");
    }
